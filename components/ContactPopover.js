...
export default function ContactPopover() {
  return (
    <Popover className="inline-block w-auto">
      <PopoverTrigger asChild>
        <button className="flex items-center gap-2.5 border border-[var(--color-brand)] hover:bg-[var(--color-brand)]/5 text-[var(--color-brand)] rounded-lg px-4 py-2.5 transition-colors">
          <Phone size={18} className="shrink-0" />
          <span className="text-sm font-semibold hidden sm:inline">07 45 89 18 65</span>
      ...
      <PopoverContent align="end" className="w-72 p-3 flex flex-col gap-2">
        <a
          ...
          className="flex items-center gap-3 rounded-lg border border-gray-100 p-3 hover:border-[var(--color-brand)] hover:bg-[var(--color-brand)]/5 transition-colors"
        >
        ...
        <a
          ...
          className="flex items-center gap-3 rounded-lg border border-gray-100 p-3 hover:border-[var(--color-brand)] hover:bg-[var(--color-brand)]/5 transition-colors"
        >
          <span className="w-10 h-10 rounded-full bg-[var(--color-brand)]/10 text-[var(--color-brand)] flex items-center justify-center shrink-0">
            <Phone size={18} />
          </span>
          <div className="flex flex-col">
